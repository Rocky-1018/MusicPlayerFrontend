...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#333', color: '#fff', padding: 14, borderRadius: 8, marginBottom: 15 },
  button: { backgroundColor: '#1DB954', paddingVertical: 14, borderRadius: 8, alignItems: 'center' },
